...
export default function Hero() {
  ...
  const highlights = [
    ...
    },
    {
      ...
      detail: "AWS, Docker, Full-Stack Development, and Software Deployment",
      meta: "Since Sep 2023",
            ...
            {t('hero.description')}
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <a
                    href="mailto:misumimatsudo@gmail.com"
                    aria-label="Email"
                    className="inline-flex h-12 w-12 items-center justify-center rounded-lg border border-white/20 bg-white/10 text-cyan-100 transition-all hover:-translate-y-0.5 hover:border-cyan-300/50 hover:bg-white/15"
                  >
